...
<html>
   ...
   <!-- Welcoming individual -->
        ...
        <ul class = "nav nav-tabs">
            <li class = "active"><a href = "adminhomepage.php">홈</a></li>
            ...
            <li class = "dropdown"><a class = "dropdown-toggle" data-toggle = "dropdown" href= "#">유저관리
                <span class="caret"></span></a>
                <ul class = "dropdown-menu">
                    <li><a href = "userManage.php">유저관리</a></li>
                </ul>
            </li>
        </ul>
    </body>
...
$result = mysqli_query($conn,"SELECT * FROM ny_users");
?>
